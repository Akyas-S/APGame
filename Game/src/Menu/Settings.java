...
public class Settings implements ActionListener {
    ...
    Settings(){
        ...
        Setticon.setIcon(new javax.swing.ImageIcon("/Users/hello/IdeaProjects/Game/src/Menu/GUI/Menu/settings.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else if (e.getSource() == Videobtn) {
            SettWind.setVisible(false);
            VideoSettings VideoSett = new VideoSettings();}
